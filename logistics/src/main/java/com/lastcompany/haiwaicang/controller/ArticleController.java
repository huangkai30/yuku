package com.lastcompany.haiwaicang.controller;

import com.lastcompany.haiwaicang.entity.*;
import com.lastcompany.haiwaicang.service.*;
...
public class ArticleController {
	...
	public ResponseEntity<Article> getArticleById(@RequestParam("title") String title) {
